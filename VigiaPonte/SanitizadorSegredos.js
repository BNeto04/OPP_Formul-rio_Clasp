...
function sanitizarTexto(texto) {
  ...
  limpo = limpo.replace(/bot\d{8,12}:[A-Za-z0-9_-]{20,45}/gi, 'bot[REDACTED_TELEGRAM_TOKEN]');
  limpo = limpo.replace(/\b\d{8,12}:[A-Za-z0-9_-]{20,45}\b/g, '[REDACTED_TELEGRAM_TOKEN]');
