...
class Comparator {
  ...
  parearDatasets(arrayV1, arrayV2) {
    ...
    // --- INÍCIO DEPURAÇÃO (SOMENTE EM MODO DEBUG) ---
    if (typeof CONFIG_SYNTHEON !== 'undefined' && CONFIG_SYNTHEON.DEBUG && typeof Logger !== 'undefined') {
      ...
      Object.keys(mapaV2).forEach(chaveV2 => {
         if (!mapaV1[chaveV2] && divergenciasLogadas < 5) {
             ...
             const matriculaV2ApenasNumeros = String(regV2.matricula).replace(/\D/g, '');
