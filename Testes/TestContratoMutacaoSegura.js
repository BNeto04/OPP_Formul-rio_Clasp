...
test('todos os 29 codigos reais do Guardiao estao cobertos pelo contrato (nenhum desconhecido)', () => {
  const codigosReais = ['TUNEL_SEM_FATOS', 'TUNEL_SEM_EQUIPE', 'TUNEL_FRAGMENTADO', 'RATEIO_PONTOS_INCOERENTE',
    ...
    'MIKE_DATA_DIVERGENTE', 'MIKE_BOE_DIVERGENTE', 'BOE_AUSENTE', 'MERITO_ARMAS_EMPATE_ANTIGUIDADE', 'MERITO_ARMAS_ANTIGUIDADE_AUSENTE',
  ...
  assert.strictEqual(codigosReais.length, 31);
  const desconhecidos = [];
  const mutaveis = [];
