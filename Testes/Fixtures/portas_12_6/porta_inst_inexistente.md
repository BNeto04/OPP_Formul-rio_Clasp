...
Resposta coberta pela Instalacao transversal `INST-NAO-EXISTE-999` (§8.11).

## Checklist de produção (§12.6)

| Item | Estado | Resposta (fato medido) |
|---|---|---|
| idempotente | nao_aplicavel | Nao incide nesta porta de teste: motivo declarado e suficientemente longo. |
