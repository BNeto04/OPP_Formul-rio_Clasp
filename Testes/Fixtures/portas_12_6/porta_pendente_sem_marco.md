...
- **Estado:** AMARELO — 1 item pendente SEM aceite formal (bloqueia G7)
...
| race_condition | pendente | **Justificativa:** pendencia declarada de teste SEM aceite formal; a decisao exigida esta escrita, mas nao ha marco. |
