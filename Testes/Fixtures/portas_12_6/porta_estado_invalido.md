...
|---|---|---|
| idempotente | sim | Nao incide nesta porta de teste: motivo declarado e suficientemente longo. |
...
| race_condition | nao_aplicavel | Nao incide nesta porta de teste: motivo declarado e suficientemente longo. |
| cache | nao_aplicavel | Nao incide nesta porta de teste: motivo declarado e suficientemente longo. |
