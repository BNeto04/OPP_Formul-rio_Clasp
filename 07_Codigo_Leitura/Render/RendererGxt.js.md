...
- **Arquivo de origem (link para o disco):** [`Render/RendererGxt.js`](../../Render/RendererGxt.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:53-03:00

## Código-fonte embutido

Verbatim de `Render/RendererGxt.js` em `fbb0608`. sha256 do bloco (LF): `5b13ffcefa226b3424f851fc979e99cb9f0cf96c3010eb79c22ee83857942630` — 284 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `RendererGxt`
- Membros públicos observados: `CORES_PELOTAO`, `corPorArmas`, `obterEstiloPelotao`, `renderizar`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:53-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T2 artefato declarado no endereco: "Render/RendererGxt.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Render/RendererGxt.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Render/RendererGxt.js" como origem
...
- 2026-09-13T21:45:53-03:00 · commit `fbb0608` · sha256 da origem (LF): `5b13ffcefa226b3424f851fc979e99cb9f0cf96c3010eb79c22ee83857942630`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C06_Relatorios/MOD-C06-02_MERITO_DE_ARMAS_GXT --origem Render/RendererGxt.js --saida <caminho>`
