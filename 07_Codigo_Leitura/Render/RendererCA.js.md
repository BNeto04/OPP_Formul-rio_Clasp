...
- **Arquivo de origem (link para o disco):** [`Render/RendererCA.js`](../../Render/RendererCA.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:51-03:00

## Código-fonte embutido

Verbatim de `Render/RendererCA.js` em `fbb0608`. sha256 do bloco (LF): `1eed53ce91fd23042e548e6fcbbb537ba3b5f733dc5bc3649b099b4ea3d3439a` — 290 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `RendererCA`
- Membros públicos observados: `renderizar`, `aplicarCoresOperacionais`, `corPorGrupo`, `corPorArmas`, `renderizarLegenda`, `renderizarCarimbo`, `ajustarLayout`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:51-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T2 artefato declarado no endereco: "Render/RendererCA.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Render/RendererCA.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Render/RendererCA.js" como origem
...
- 2026-09-13T21:45:51-03:00 · commit `fbb0608` · sha256 da origem (LF): `1eed53ce91fd23042e548e6fcbbb537ba3b5f733dc5bc3649b099b4ea3d3439a`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C06_Relatorios/MOD-C06-01_RELATORIOS_OFICIAIS --origem Render/RendererCA.js --saida <caminho>`
