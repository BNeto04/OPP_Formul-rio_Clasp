# ESPELHO — CPM – Compilador de Pontuação Mensal.js
...
- **Arquivo de origem (link para o disco):** [`CPM – Compilador de Pontuação Mensal.js`](../CPM – Compilador de Pontuação Mensal.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:44:56-03:00

## Código-fonte embutido

Verbatim de `CPM – Compilador de Pontuação Mensal.js` em `fbb0608`. sha256 do bloco (LF): `ca24949aaba3b6ea4393f7fd64387ced4e7ebac3cc0a44fa2685a0b13e7723d6` — 339 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `abrirMenuCPMMensal`, `abrirMenuCPMLivre`, `gerarCPMAnual`, `gerarCPMMensal`, `calcularPeriodoCPM`, `obterAbasDoPeriodoCPM`, `executarCompiladorCPM`, `corPorGrupoCpm_`, `criarAbaResultadoCPM_`, `CONFIG_CPM`, `ALIASES_CPM`
- Membros públicos observados: `executarCompiladorCPM`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:44:56-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T3 arquivo presente no commit de referencia (fbb0608:CPM – Compilador de Pontuação Mensal.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "CPM – Compilador de Pontuação Mensal.js" como origem
- **ACHADO** — T2 artefato NAO declarado no endereco: "CPM – Compilador de Pontuação Mensal.js" nao aparece nas NOTAS/capsula de C06_Relatorios / MOD-C06-01_RELATORIOS_OFICIAIS
...
- 2026-09-13T21:44:56-03:00 · commit `fbb0608` · sha256 da origem (LF): `ca24949aaba3b6ea4393f7fd64387ced4e7ebac3cc0a44fa2685a0b13e7723d6`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C06_Relatorios/MOD-C06-01_RELATORIOS_OFICIAIS --origem CPM – Compilador de Pontuação Mensal.js --saida <caminho>`
