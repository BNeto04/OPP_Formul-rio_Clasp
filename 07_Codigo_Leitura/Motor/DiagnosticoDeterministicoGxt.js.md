# ESPELHO — DiagnosticoDeterministicoGxt.js
...
- **Arquivo de origem (link para o disco):** [`Motor/DiagnosticoDeterministicoGxt.js`](../../Motor/DiagnosticoDeterministicoGxt.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:38-03:00

## Código-fonte embutido

Verbatim de `Motor/DiagnosticoDeterministicoGxt.js` em `fbb0608`. sha256 do bloco (LF): `dfe3102725260dd56e71d5d00e3c46bcfe2b005694c66248a67f68df53843e06` — 427 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `DiagnosticoDeterministicoGxt`
- Membros públicos observados: `formatarData`, `diagnosticarMes`, `montarMatrizDiagnostico`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:38-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T2 artefato declarado no endereco: "Motor/DiagnosticoDeterministicoGxt.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Motor/DiagnosticoDeterministicoGxt.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Motor/DiagnosticoDeterministicoGxt.js" como origem
...
- 2026-09-13T21:45:38-03:00 · commit `fbb0608` · sha256 da origem (LF): `dfe3102725260dd56e71d5d00e3c46bcfe2b005694c66248a67f68df53843e06`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C04_Motor/MOD-C04-01_MOTOR_ANALITICO --origem Motor/DiagnosticoDeterministicoGxt.js --saida <caminho>`
