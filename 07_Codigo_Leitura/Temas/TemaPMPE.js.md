...
- **Arquivo de origem (link para o disco):** [`Temas/TemaPMPE.js`](../../Temas/TemaPMPE.js)
...
Verbatim de `Temas/TemaPMPE.js` em `fbb0608`. sha256 do bloco (LF): `a1f29ccd412fc49ea9e1f696c9481f7cb7b74b8f18092fd2cf1a0eec5b4d7b44` — 28 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `TemaPMPE`
- Membros públicos observados: `corCabecalho`, `corND`, `corFundoPadrao`, `corPelotao`, `corGraduacao`
...
- OK — T3 arquivo presente no commit de referencia (fbb0608:Temas/TemaPMPE.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Temas/TemaPMPE.js" como origem
- **ACHADO** — T2 artefato NAO declarado no endereco: "Temas/TemaPMPE.js" nao aparece nas NOTAS/capsula de C06_Relatorios / MOD-C06-01_RELATORIOS_OFICIAIS
...
- 2026-09-13T21:45:56-03:00 · commit `fbb0608` · sha256 da origem (LF): `a1f29ccd412fc49ea9e1f696c9481f7cb7b74b8f18092fd2cf1a0eec5b4d7b44`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C06_Relatorios/MOD-C06-01_RELATORIOS_OFICIAIS --origem Temas/TemaPMPE.js --saida <caminho>`
