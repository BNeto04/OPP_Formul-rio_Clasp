...
- **Arquivo de origem (link para o disco):** [`Core/LeitorPlanilhas.js`](../../Core/LeitorPlanilhas.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:05-03:00

## Código-fonte embutido

Verbatim de `Core/LeitorPlanilhas.js` em `fbb0608`. sha256 do bloco (LF): `afb5b25053a7dfb0f95f0bedc853594393c3812d70b4ab077cd8262e6e219397` — 509 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `diagnosticarCaminhoArmasHeadless`, `verificarParticipacaoArmasHeadless`, `verificarQtdOcorrenciasHeadless`, `verificarDrogasHeadless`, `verificarPontuacaoHeadless`, `SyntheonLeitor`
- Membros públicos observados: `lerAbas`, `_mapearColunas`, `_processarLinha`, `_acumularMetricasPolicial`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:05-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T2 artefato declarado no endereco: "Core/LeitorPlanilhas.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Core/LeitorPlanilhas.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Core/LeitorPlanilhas.js" como origem
...
- **Enderecos concorrentes declarados na Planta (3):** `C03_Dominio/MOD-C03-01_MODELO_DE_OCORRENCIA`, `C04_Motor/MOD-C04-01_MOTOR_ANALITICO`, `C06_Relatorios/MOD-C06-01_RELATORIOS_OFICIAIS`. O artefato e referenciado em mais de um endereco; o campo acima registra o endereco PRIMARIO. Nao e erro de endereco — e declaracao concorrente na propria Planta.
...
- 2026-09-13T21:45:05-03:00 · commit `fbb0608` · sha256 da origem (LF): `afb5b25053a7dfb0f95f0bedc853594393c3812d70b4ab077cd8262e6e219397`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C02_Leitura/MOD-C02-01_LEITURA_E_ADAPTACAO --origem Core/LeitorPlanilhas.js --saida <caminho>`
