...
- **Arquivo de origem (link para o disco):** [`Core/RegrasQualidade.js`](../../Core/RegrasQualidade.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:10-03:00

## Código-fonte embutido

Verbatim de `Core/RegrasQualidade.js` em `fbb0608`. sha256 do bloco (LF): `f97b2917e1713866bb08e722646e4f196feaf0bccbcdc03f8fcba851d32ec371` — 790 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `RegrasQualidade`
- Membros públicos observados: `criarDiagnostico`, `validarTunel`, `validarMeritoArmasTunel`, `validarDataMike`, `validarCoerenciaCruzadaMikes`, `validarIdentidadeOcorrencia`, `indicadorConhecido`, `localizarColunasCalculadas`, `validarFormulasObrigatorias`, `criarTunel`, `acumularLinhaTunel`, `validarCabecalhosObrigatorios`, `temFatoOperacional`, `localizarPorAliases`, `chaveTunel`, `mikeSuspeito`, `imputadoValido`, `texto`, `numero`, `unicos`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:10-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T2 artefato declarado no endereco: "Core/RegrasQualidade.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Core/RegrasQualidade.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Core/RegrasQualidade.js" como origem

Veredito mecânico: **nenhuma divergência detectada pelos testes acima**.

Declaração verificada a mão por humano/agente (não derivável automaticamente):

- **Como o endereco foi derivado (nao inventado):** secao Artefatos; fonte `02_Comodos/C05_Guardiao/01_Dominio/modulos/MOD-C05-01_GUARDIAO_DE_QUALIDADE/MOD-C05-01_GUARDIAO_DE_QUALIDADE.md`:62.
...
- **Enderecos concorrentes declarados na Planta (3):** `C01_Entrada/MOD-C01-01_FORMULARIO_E_MENUS/SUB-C01-01-01_OCR_E_CONFERENCIA`, `C03_Dominio/MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO`, `C04_Motor/MOD-C04-01_MOTOR_ANALITICO`. O artefato e referenciado em mais de um endereco; o campo acima registra o endereco PRIMARIO. Nao e erro de endereco — e declaracao concorrente na propria Planta.
- **Divergencia com o espelho anterior:** o espelho antigo declarava o modulo `MOD-C00-01_INFRAESTRUTURA_CORE`; a derivacao atual chega a `C05_Guardiao/MOD-C05-01_GUARDIAO_DE_QUALIDADE`. Divergencia declarada, nao sobrescrita em silencio.
...
- 2026-09-13T21:45:10-03:00 · commit `fbb0608` · sha256 da origem (LF): `f97b2917e1713866bb08e722646e4f196feaf0bccbcdc03f8fcba851d32ec371`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C05_Guardiao/MOD-C05-01_GUARDIAO_DE_QUALIDADE --origem Core/RegrasQualidade.js --saida <caminho>`
