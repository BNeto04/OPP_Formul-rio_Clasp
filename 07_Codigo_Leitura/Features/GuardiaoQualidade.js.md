...
- **Arquivo de origem (link para o disco):** [`Features/GuardiaoQualidade.js`](../../Features/GuardiaoQualidade.js)
...
Verbatim de `Features/GuardiaoQualidade.js` em `fbb0608`. sha256 do bloco (LF): `aa889f6efa6671d26205fb376240ebe1a556938f625b7f779a438237131806c6` — 707 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `GuardiaoQualidade`, `executarGuardiaoQualidade`
- Membros públicos observados: `normalizarNomeFlexivel`, `localizarAbaCatalogoPIP`, `localizarLinhaCabecalhoCatalogo`, `varrerAba`
...
- OK — T2 artefato declarado no endereco: "Features/GuardiaoQualidade.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Features/GuardiaoQualidade.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Features/GuardiaoQualidade.js" como origem
...
- 2026-09-13T21:45:33-03:00 · commit `fbb0608` · sha256 da origem (LF): `aa889f6efa6671d26205fb376240ebe1a556938f625b7f779a438237131806c6`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C05_Guardiao/MOD-C05-01_GUARDIAO_DE_QUALIDADE --origem Features/GuardiaoQualidade.js --saida <caminho>`
