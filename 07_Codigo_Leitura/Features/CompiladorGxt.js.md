...
- **Arquivo de origem (link para o disco):** [`Features/CompiladorGxt.js`](../../Features/CompiladorGxt.js)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:30-03:00

## Código-fonte embutido

Verbatim de `Features/CompiladorGxt.js` em `fbb0608`. sha256 do bloco (LF): `ec831f882c62610a31cb633951c43101a53cf9122a2950c784b35603b452f03f` — 969 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `CompiladorGxt`, `abrirMenuGxtSelecaoLivre`, `gerarGxtSelecaoLivre`, `gerarGxtAnual`, `diagnosticarGxtMes_`, `diagnosticarGxtAbril_`
- Membros públicos observados: `normalizarNomeAba`, `localizarAbaMes`, `compilar`, `gerarLogOperacionalGxt`, `formatarDiagnosticoEAcao`
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:30-03:00):

- OK — T1 endereco existe: NOTA_DE_RESPONSABILIDADE.md do modulo presente
- OK — T3 arquivo presente no commit de referencia (fbb0608:Features/CompiladorGxt.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Features/CompiladorGxt.js" como origem
- **ACHADO** — T2 artefato NAO declarado no endereco: "Features/CompiladorGxt.js" nao aparece nas NOTAS/capsula de C06_Relatorios / MOD-C06-02_MERITO_DE_ARMAS_GXT

Veredito mecânico: **1 divergência(s) detectada(s) pelos testes acima**.

Declaração verificada a mão por humano/agente (não derivável automaticamente):

- **Como o endereco foi derivado (nao inventado):** menção em arquivo do próprio endereço; fonte `02_Comodos/C06_Relatorios/01_Dominio/modulos/MOD-C06-02_MERITO_DE_ARMAS_GXT/CIR-MOD-C06-02_MERITO_DE_ARMAS_GXT.canvas`.
- **Enderecos concorrentes declarados na Planta (2):** `C01_Entrada/MOD-C01-01_FORMULARIO_E_MENUS`, `C03_Dominio/MOD-C03-01_MODELO_DE_OCORRENCIA`. O artefato e referenciado em mais de um endereco; o campo acima registra o endereco PRIMARIO. Nao e erro de endereco — e declaracao concorrente na propria Planta.
...
- 2026-09-13T21:45:30-03:00 · commit `fbb0608` · sha256 da origem (LF): `ec831f882c62610a31cb633951c43101a53cf9122a2950c784b35603b452f03f`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C06_Relatorios/MOD-C06-02_MERITO_DE_ARMAS_GXT --origem Features/CompiladorGxt.js --saida <caminho>`
