...
- **Endereço Down Plant:** `C03_Dominio / MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO / SUB-C03-02-02_FONTES_E_PROVENIENCIA` — [NOTA_DE_RESPONSABILIDADE.md](../../../02_Comodos/C03_Dominio/01_Dominio/modulos/MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO/submodulos/SUB-C03-02-02_FONTES_E_PROVENIENCIA/NOTA_DE_RESPONSABILIDADE.md)
- **Arquivo de origem (link para o disco):** [`Dominio/ARCA/ARCA_FONTES.md`](../../../Dominio/ARCA/ARCA_FONTES.md)
- **Commit de referência:** `fbb0608e7b98144533628c7f9b773a10505b800d` (`fbb0608`)
- **Data da última sincronização:** 2026-09-13T21:45:13-03:00

## Código-fonte embutido

Verbatim de `Dominio/ARCA/ARCA_FONTES.md` em `fbb0608`. sha256 do bloco (LF): `c91d3b19c5b8b9a5ba440f2e508e18608fe8c00cde40a0b02b7f2112d832d147` — 98 linhas.
...
Fonte: `02_Comodos/C03_Dominio/01_Dominio/modulos/MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO/submodulos/SUB-C03-02-02_FONTES_E_PROVENIENCIA/NOTA_DE_RESPONSABILIDADE.md` — NOTA_DE_RESPONSABILIDADE.md do submodulo, "## Papel".

Registra autoridade e proveniencia de cada regra: fontes oficiais normativas, internas operacionais, heuristicas derivadas e desconhecidas. Distribuicao atual: 11 CANONICAL_SOURCE_CONFIRMED, 18 INTERNAL_SOURCE_CONFIRMED, 2 DOMAIN_RULE_SOURCE_UNKNOWN, 0 conflitos declarados.

Fonte: `02_Comodos/C03_Dominio/01_Dominio/modulos/MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO/submodulos/SUB-C03-02-02_FONTES_E_PROVENIENCIA/NOTA_DE_RESPONSABILIDADE.md` — NOTA_DE_RESPONSABILIDADE.md do submodulo, "## Limites".

- Nao inventa fonte; regra sem norma permanece como interna/desconhecida.
...
Testes mecânicos executados na geração (commit `fbb0608`, 2026-09-13T21:45:13-03:00):
...
- OK — T2 artefato declarado no endereco: "Dominio/ARCA/ARCA_FONTES.md" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Dominio/ARCA/ARCA_FONTES.md)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Dominio/ARCA/ARCA_FONTES.md" como origem

Veredito mecânico: **nenhuma divergência detectada pelos testes acima**.

Declaração verificada a mão por humano/agente (não derivável automaticamente):

- **Como o endereco foi derivado (nao inventado):** tabela de artefatos; fonte `02_Comodos/C03_Dominio/01_Dominio/modulos/MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO/NOTA_DE_RESPONSABILIDADE.md`:25.
...
- 2026-09-13T21:45:13-03:00 · commit `fbb0608` · sha256 da origem (LF): `c91d3b19c5b8b9a5ba440f2e508e18608fe8c00cde40a0b02b7f2112d832d147`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C03_Dominio/MOD-C03-02_ARCA_DE_REGRAS_DE_DOMINIO/SUB-C03-02-02_FONTES_E_PROVENIENCIA --origem Dominio/ARCA/ARCA_FONTES.md --saida <caminho>`
