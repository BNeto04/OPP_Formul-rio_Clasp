...
- **Arquivo de origem (link para o disco):** [`Entrada/EntradaManual.js`](../../Entrada/EntradaManual.js)
...
Verbatim de `Entrada/EntradaManual.js` em `fbb0608`. sha256 do bloco (LF): `d13e5d00866ddf9b0a998fae5606a6ab4c5df4726accd74cc3537ea4805dfb08` — 824 linhas.
...
- Superfície exposta no nível do arquivo (nível global): `qtdOcorrenciaPadrao_`, `obterSpreadsheetOcorrencias_`, `_processarEntradaManual`, `processarEntradaManual`, `resolverNomeAbaMensal`, `localizarAbaMensalTratada`, `verificarDuplicidadeOcorrencia`, `montarLinhasEntradaManual`, `localizarBlocoModeloDisponivel_`, `gravarLinhasEntradaManual`, `obterOpcoesValidacao`, `getEfetivo`, `obterTabelaTerritorialAIS`, `resolverAISTerritorial`, `corrigirDataBloco`, `corrigirBlocoOcorrencia`, `corrigirDetidos`, `obterMetadadosArcaVeiculo`
- Membros públicos observados: `verificarDuplicidadeOcorrencia`
...
- OK — T2 artefato declarado no endereco: "Entrada/EntradaManual.js" aparece na Planta
- OK — T3 arquivo presente no commit de referencia (fbb0608:Entrada/EntradaManual.js)
- OK — T4 conteudo em disco identico ao do commit de referencia (sha256 LF)
- OK — T5 espelho anterior sem deriva de codigo (sha256 do bloco == origem)
- OK — T6 endereco declarado no espelho anterior corresponde ao endereco canonico atual
- OK — T7 sem duplicidade: exatamente 1 espelho de leitura declara "Entrada/EntradaManual.js" como origem
...
- **Enderecos concorrentes declarados na Planta (3):** `C01_Entrada/MOD-C01-01_FORMULARIO_E_MENUS/SUB-C01-01-01_OCR_E_CONFERENCIA`, `C01_Entrada/MOD-C01-01_FORMULARIO_E_MENUS/SUB-C01-01-02_PERSISTENCIA_MANUAL`, `C03_Dominio/MOD-C03-01_MODELO_DE_OCORRENCIA`. O artefato e referenciado em mais de um endereco; o campo acima registra o endereco PRIMARIO. Nao e erro de endereco — e declaracao concorrente na propria Planta.
- **Divergencia com o espelho anterior:** o espelho antigo declarava o modulo `SUB-C01-01-02`; a derivacao atual chega a `C01_Entrada/MOD-C01-01_FORMULARIO_E_MENUS`. Divergencia declarada, nao sobrescrita em silencio.
...
- 2026-09-13T21:45:27-03:00 · commit `fbb0608` · sha256 da origem (LF): `d13e5d00866ddf9b0a998fae5606a6ab4c5df4726accd74cc3537ea4805dfb08`
- Reexecutar: `node scripts/downplant/espelho-rico.mjs gerar --endereco C01_Entrada/MOD-C01-01_FORMULARIO_E_MENUS --origem Entrada/EntradaManual.js --saida <caminho>`
