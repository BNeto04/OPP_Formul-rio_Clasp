...
- **DiretÃ³rio `02_Comodos/`**: ContÃ©m pastas (`01_SPRINTS`, `02_SPECS`, `03_TASKS`, `04_PROTOCOLS`) e mapeamentos de features (`M01_ENTRADA.md`, `M02_LEITURA_INVENTARIO.md`, `M03_DOMINIO_INVENTARIO.md`, `M04_MOTOR_INVENTARIO.md`, `M05_GUARDIAO_HOMOLOGACAO.md`, `C06.3_DIAGNOSTICO_GXT_2T.md`, etc.).
