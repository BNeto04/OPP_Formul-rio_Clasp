...
> **Documento:** `02_Comodos/02_SPECS/M06_RELATORIOS_SPEC.md`  
...
Conforme registrado em `M06_RELATORIOS_SPEC.md` (seÃƒÂ§ÃƒÂ£o 1.1), a paleta oficial de pelotÃƒÂµes e graduaÃƒÂ§ÃƒÂµes ÃƒÂ© estritamente a seguinte:
