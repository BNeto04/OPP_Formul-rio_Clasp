...
Foi definida a **porta canonica** para a condicao de dominio do titulo PIP de veiculo: `AdaptadorConsultaArca.consultarPorRuleId('ARCA-VEICULO-001')`, com fail-soft. Estado: **PLANEJADO** — o formulario ainda NAO consome (REAL_CODE_CONSUMER vazio); a integracao entra no #138. Fronteira: a ARCA rege a CONDICAO de dominio; o parser segue responsavel por ler o BO e pela realizacao lexical (heuristica OCR). O Canvas/Planta Mestra sera atualizado no #138, quando o consumo existir de fato no codigo.
