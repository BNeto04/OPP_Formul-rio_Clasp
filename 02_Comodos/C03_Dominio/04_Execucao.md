...
| :--- | :--- | :--- | :--- | :--- |
| `TASK-C03.1-01` | InventÃ¡rio detalhado das entidades e Value Objects | `02_Comodos/M03_DOMINIO_INVENTARIO.md` | **CONCLUÃDA** | `a01d1b9` |
...
| `TASK-C03.1-03` | Auditoria de pureza arquitetural da camada de DomÃ­nio (isolar I/O e GAS) | `02_Comodos/M03_DOMINIO_PUREZA.md`, `Dominio/*.js` | **CONCLUÃDA** | `7430361` |
| `TASK-C03.1-04` | Registrar invariantes finais do DomÃ­nio na especificaÃ§Ã£o tÃ©cnica | `02_Comodos/02_SPECS/M03_DOMINIO_SPEC.md` | **CONCLUÃDA** | `ec0200e` |
...
- **`02_Comodos/M03_DOMINIO_INVENTARIO.md`**: InventÃƒÂ¡rio completo das 9 entidades e Value Objects.
- **`02_Comodos/M03_DOMINIO_PUREZA.md`**: RelatÃƒÂ³rio de pureza garantindo 0% de acoplamento a I/O ou Apps Script.
- **`02_Comodos/02_SPECS/M03_DOMINIO_SPEC.md`**: EspecificaÃƒÂ§ÃƒÂ£o tÃƒÂ©cnica com seÃƒÂ§ÃƒÂ£o formal de Invariantes do DomÃƒÂ­nio.
