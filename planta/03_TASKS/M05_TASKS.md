...
> **Status Geral do Cômodo:** EM EXECUÇÃO (TASK-M05.1-01 a TASK-M05.1-04D CONCLUÍDAS)  
...
| `TASK-M05.1-04D` | Normalização estrita de aliases (hífen/underline) e remoção de fallback para Coluna A | `Features/GuardiaoQualidade.js`, `Testes/TestGuardiao.js` | **CONCLUÍDA** | `em_progresso` |
