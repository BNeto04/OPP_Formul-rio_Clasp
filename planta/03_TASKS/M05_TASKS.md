...
> **Status Geral do Cômodo:** EM EXECUÇÃO (TASK-M05.1-01 a TASK-M05.1-04C CONCLUÍDAS)  
...
| `TASK-M05.1-04C` | Localização flexível por aliases da Tabela PIP/coluna e tratamento de catálogo vazio | `Features/GuardiaoQualidade.js`, `Testes/TestGuardiao.js` | **CONCLUÍDA** | `em_progresso` |
