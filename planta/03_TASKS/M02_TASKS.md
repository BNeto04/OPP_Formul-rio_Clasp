...
| `TASK-M02.1-04` | Padronizar busca flexível de colunas por apelidos/aliases de cabeçalho com módulo `Core/Cabecalhos.js` | `Core/Cabecalhos.js`, `Leitura/Adaptador2026.js`, `Core/LeitorPlanilhas.js` | **CONCLUÍDA** | `em_progresso` |
